...
lazy val root = (project in file("."))
  .settings(
    ...
    libraryDependencies ++= Seq(
      "org.apache.flink"        % "flink-streaming-java"    % "1.15.4",
      "org.apache.flink"        % "flink-java"              % "1.15.4",
      "io.findify"             %% "flink-adt"               % "0.6.1",
      "org.scalatest"          %% "scalatest"               % "3.2.12" % Test,
      "org.apache.flink"        % "flink-test-utils"        % "1.15.4" % Test,
      "org.apache.flink"        % "flink-test-utils-junit"  % "1.15.4" % Test,
